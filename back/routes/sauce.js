...
router.post("/", auth, /*inputValidation.main,*/ multer, sauceCtrl.createSauce) // identification checked in controller
router.put(
  "/:id",
  auth,
  /*inputValidation.main,*/ multer,
  sauceCtrl.updateSauce
) // identification checked in auth if no file is added and in controller otherwise
